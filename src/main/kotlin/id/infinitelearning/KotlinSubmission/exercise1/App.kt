 ...
 */
fun myProfile() {
    val firstName: String = "Sabrina"
    val lastName: String = "Kurnia"
    val umur: Int = 21
 ...
 */
fun myGroup(): String {
    val groupMembers = listOf("Sabrina", "Yevi", "Berlian", "Damar", "Rafy", "Rizki")
...
fun main() {
     ...
     *
     */
    groupDetail(4, listOf("Sabrina", "Yevi", "Berlian", "Damar", "Rafy", "Rizki"), "Morning")
